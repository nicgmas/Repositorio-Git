...
#ordenação
matriculas = ["Yasmin" , "Maria Clara" , "Gisseli" , "Raiane", "Ana Luiza", "Sophia" , "Isabelle" , "Beatriz"]
matriculas.sort()
print(matriculas)
...
for i in range(len(vetor_numerico)):
    vetor_numerico[i] *=2 #vetor-numerico[i] = vetor_numerico[2] *2
pritn(vetor_numerico)
