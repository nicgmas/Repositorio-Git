'''Desenvolver um programa para ajudar o setor de RH a 
analisar os salários dos colaboradores de empresa
...
*contar quantos colaboradores ganham acima da média slarial
